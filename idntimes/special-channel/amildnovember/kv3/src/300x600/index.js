...
p.nominalBounds = new cjs.Rectangle(0,0,330,621);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-171,-241,1,1.0457);
...
p.nominalBounds = new cjs.Rectangle(-171,-241,320,502);
...
p.nominalBounds = new cjs.Rectangle(-255,-365,480,903.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-165,-259,1.0377,1.0377);
...
p.nominalBounds = new cjs.Rectangle(-165,-259,331,622.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-165,-262,1.047,1.047);
...
p.nominalBounds = new cjs.Rectangle(-165,-262,334,628.2);
...
p.nominalBounds = new cjs.Rectangle(-160,-240,319,600);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(157.3,239.1,1.0458,1.0458);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(66).to({_off:false},0).to({alpha:1},5).wait(27).to({startPosition:0},0).to({regX:0.2,regY:0.2,scaleX:0.9263,scaleY:0.9263,x:214,y:213},9,cjs.Ease.sineOut).wait(99));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-27.1,377.6,642.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_5.setTransform(203.6388,467.797,0.1019,0.1019);
	...
	this.shape_6.setTransform(194.8653,467.7766,0.1019,0.1019);
	...
	this.shape_7.setTransform(241.523,446.4252,0.816,0.816);
	...
	this.instance_2.setTransform(153,104.5,1,1,0,0,0,160,240);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(206));

	// Layer_5
	this.instance_3 = new lib.text2();
	this.instance_3.setTransform(138.2,70.75,1.0954,1.0954,0,0,0,127.3,58.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(206));

	// text
	this.instance_4 = new lib.text1();
	this.instance_4.setTransform(123.7,41.95,1.0954,1.0954,0,0,0,113.5,35.8);
	...
	// Layer_1
	this.instance_6 = new lib.outfit();
	this.instance_6.setTransform(138.95,287.35,1.0542,1.0542,0,0,0,164.5,240.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(206));

	// Layer_6
	this.instance_7 = new lib.avatar();
	this.instance_7.setTransform(150,311.9,1.0651,1.0651,0,0,0,159.5,299.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(206));

	// bg
	this.instance_8 = new lib.Tween15("synched",0);
	this.instance_8.setTransform(159.95,239.95,1.0094,1.0094);
	...
	this.instance_9.setTransform(160,240,0.6667,0.6667);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(100).to({startPosition:0},0).to({scaleX:0.7083,scaleY:0.7083},7).wait(99));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(115.6,164.5,209.1,483.70000000000005);
// library properties:
lib.properties = {
	id: '33FFBE7916772A40A4EF1C2D32DE6F96',
	width: 300,
	height: 600,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['33FFBE7916772A40A4EF1C2D32DE6F96'] = {
