...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[484,0,240,1000],[0,0,240,1000],[242,0,240,1000],[726,0,240,1000]]}
];
...
(lib.Scene_1_b = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(86.65,300.95,0.33,0.33);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.instance_1 = new lib.Tween6("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(165.3,103.8,1.1698,1.1698);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({_off:false},0).to({_off:true,scaleX:1.1698,scaleY:1.1698,x:165.3,y:103.8,alpha:1},6,cjs.Ease.quadOut).wait(79).to({_off:false,scaleX:0.33,scaleY:0.33,x:86.65,y:300.95,alpha:0},0).to({_off:true,scaleX:1.1698,scaleY:1.1698,x:165.3,y:103.8,alpha:1},6,cjs.Ease.quadOut).wait(5));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},6,cjs.Ease.quadOut).wait(1).to({x:165.65,y:103.5},0).to({regX:0.1,regY:0.1,scaleX:1.0001,scaleY:1,x:150.1,y:125.1},3).to({_off:true},46).wait(29).to({_off:false,regX:0,regY:0,scaleX:1.1698,scaleY:1.1698,x:165.3,y:103.8},6,cjs.Ease.quadOut).wait(1).to({x:165.65,y:103.5},0).to({regX:0.1,regY:0.1,scaleX:1.0001,scaleY:1,x:150.1,y:125.1},3).wait(1));
...
(lib.Scene_1_a = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(76.85,125.05,0.2027,0.2027);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.instance_1 = new lib.Tween4("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(168.05,125,1.174,1.174);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({_off:true,scaleX:1.174,scaleY:1.174,x:168.05,y:125,alpha:1},6,cjs.Ease.quadOut).wait(79).to({_off:false,scaleX:0.2027,scaleY:0.2027,x:76.85,y:125.05,alpha:0},0).to({_off:true,scaleX:1.174,scaleY:1.174,x:168.05,y:125,alpha:1},6,cjs.Ease.quadOut).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},6,cjs.Ease.quadOut).wait(1).to({x:168.1},0).to({scaleX:1,scaleY:1,x:150},3,cjs.Ease.quadIn).to({_off:true},66).wait(9).to({_off:false,scaleX:1.174,scaleY:1.174,x:168.05},6,cjs.Ease.quadOut).wait(1).to({x:168.1},0).to({scaleX:1,scaleY:1,x:150},3,cjs.Ease.quadIn).wait(21));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.bg.name = "bg";
	this.bg.parent = this;
	this.bg.setTransform(60,250,1,1,0,0,0,60,250);
	this.bg.depth = 0;
	...
	this.bg_1.setTransform(60,250,1,1,0,0,0,60,250);
	this.bg_1.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(69.9,257.3,63.099999999999994,307.99999999999994);
// library properties:
lib.properties = {
