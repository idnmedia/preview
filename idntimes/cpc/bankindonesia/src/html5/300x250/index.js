...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,502,600,500],[0,1004,600,500],[0,1506,600,500],[0,0,600,500]]}
];
...
(lib.Scene_1_b = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(150.05,173.4,0.33,0.33);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.instance_1 = new lib.Tween6("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(150,117.45,1.1698,1.1698);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({_off:false},0).to({_off:true,scaleX:1.1698,scaleY:1.1698,x:150,y:117.45,alpha:1},6,cjs.Ease.quadOut).wait(79).to({_off:false,scaleX:0.33,scaleY:0.33,x:150.05,y:173.4,alpha:0},0).to({_off:true,scaleX:1.1698,scaleY:1.1698,x:150,y:117.45,alpha:1},6,cjs.Ease.quadOut).wait(5));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},6,cjs.Ease.quadOut).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:1.0001,scaleY:1,x:150.1,y:125.1},3).to({_off:true},46).wait(29).to({_off:false,regX:0,regY:0,scaleX:1.1698,scaleY:1.1698,x:150,y:117.45},6,cjs.Ease.quadOut).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:1.0001,scaleY:1,x:150.1,y:125.1},3).wait(1));
...
(lib.Scene_1_a = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150,125,1.174,1.174);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({_off:true,scaleX:1.174,scaleY:1.174,x:150,y:125,alpha:1},6,cjs.Ease.quadOut).wait(79).to({_off:false,scaleX:0.2027,scaleY:0.2027,x:150.1,y:125.05,alpha:0},0).to({_off:true,scaleX:1.174,scaleY:1.174,x:150,y:125,alpha:1},6,cjs.Ease.quadOut).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},6,cjs.Ease.quadOut).wait(1).to({startPosition:0},0).to({scaleX:1,scaleY:1},3,cjs.Ease.quadIn).to({_off:true},66).wait(9).to({_off:false,scaleX:1.174,scaleY:1.174},6,cjs.Ease.quadOut).wait(1).to({startPosition:0},0).to({scaleX:1,scaleY:1},3,cjs.Ease.quadIn).wait(21));
...
p.nominalBounds = new cjs.Rectangle(124,96.3,202.2,175.5);
// library properties:
lib.properties = {
	id: '4B428190795FC346AAF3C65AF1896624',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['4B428190795FC346AAF3C65AF1896624'] = {
