...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1204,1002,240,1000],[1446,0,240,1000],[1204,0,240,1000],[602,0,600,1200],[0,0,600,1200],[1688,0,240,1000],[1688,1002,240,1000],[1446,1002,240,1000]]},
		{name:"index_atlas_2", frames: [[968,0,240,1000],[968,1002,240,1000],[1210,0,240,1000],[726,1002,240,1000],[726,0,240,1000],[484,0,240,1000],[484,1002,240,1000],[242,0,240,1000],[242,1002,240,1000],[0,1002,240,1000],[0,0,240,1000]]}
];
...
p.nominalBounds = new cjs.Rectangle(-150,-125,240,1000);
...
(lib.Scene_1_orang = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(195,62.5,0.5,0.5);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},8,cjs.Ease.cubicOut).wait(75).to({startPosition:0},0).to({x:-45},7).wait(1));
...
(lib.Scene_1_onestep = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(240,128.8,2,2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(274).to({_off:false},7).wait(59).to({startPosition:0},0).to({scaleX:0.2424,scaleY:0.2424,x:81.8,y:143.55,alpha:0},7).wait(1));
...
(lib.Scene_1_logobig = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(60.15,125.1,0.8,0.8,0,0,0,0.3,0.1);
	this.instance._off = true;

	this.instance_1 = new lib.Tween38("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(60.05,125,0.4333,0.4333);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},350).to({state:[{t:this.instance_1}]},6).wait(56));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(350).to({_off:false},0).to({_off:true,regX:0,regY:0,scaleX:0.4333,scaleY:0.4333,x:60.05,y:125},6).wait(56));
...
(lib.Scene_1_kunjungi = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(240.2,142.95,2.0001,2,0,0,0,0.1,0.1);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(207).to({_off:false},8,cjs.Ease.cubicOut).wait(51).to({startPosition:0},0).to({scaleX:0.226,scaleY:0.226,x:80.35,y:106.5,alpha:0},7).wait(1));
...
(lib.Scene_1_cursor = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(195.05,62.5,0.5,0.5,0,0,0,0.1,0);
	this.instance._off = true;
...
(lib.Scene_1_car2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-90,194.8,0.2,0.2,0,0,0,0,0.3);
	this.instance._off = true;

	this.instance_1 = new lib.Tween12("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(30.05,195.9,0.2,0.2,0,0,0,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},114).to({state:[{t:this.instance_1}]},9).wait(84));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(114).to({_off:false},0).to({_off:true,regX:0.3,x:30.05,y:195.9},9,cjs.Ease.cubicOut).wait(84));
...
(lib.Scene_1_car1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},9,cjs.Ease.quadOut).wait(89).to({startPosition:0},0).to({x:-45},7).wait(1));
...
(lib.Scene_1_button = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(62.75,375.1,0.0833,0.0833,0,0,0,0.6,0.6);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(216).to({_off:false},0).to({_off:true,regX:0,regY:0,scaleX:0.5,scaleY:0.5,x:75,y:62.5},7).wait(189));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(216).to({_off:false},7).wait(29).to({startPosition:0},0).to({regX:0.1,regY:0.2,scaleX:0.4583,scaleY:0.4582,x:73.8,y:99.2},4).wait(1).to({startPosition:0},0).to({regY:0,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(65).to({regX:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.1,regY:0.2,scaleX:0.4583,scaleY:0.4582,x:73.8,y:99.2},4).wait(1).to({startPosition:0},0).to({regY:0,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(58).to({regX:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.1,regY:0.2,scaleX:0.4583,scaleY:0.4582,x:73.8,y:99.2},4).wait(1).to({startPosition:0},0).to({regY:0,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(10));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.logosmall.setTransform(60,250,1,1,0,0,0,60,250);
...
p.nominalBounds = new cjs.Rectangle(-220,178.8,606.2,714);
// library properties:
lib.properties = {
