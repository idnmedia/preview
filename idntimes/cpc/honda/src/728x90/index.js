...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,1274,1456,180],[0,1456,1456,180],[0,0,1456,180],[0,182,1456,180],[0,1638,1456,180],[0,1820,1456,180],[0,546,1456,180],[0,364,1456,180],[0,728,1456,180],[0,910,1456,180],[0,1092,1456,180]]},
		{name:"index_atlas_2", frames: [[0,182,1456,180],[0,0,1456,180],[0,546,1456,180],[0,364,1456,180],[0,728,1456,180],[0,910,1456,180],[0,1092,1456,180],[0,1274,1456,180]]}
];
...
p.nominalBounds = new cjs.Rectangle(-150,-125,1456,180);
...
(lib.Scene_1_sense = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(281).to({_off:false},0).to({_off:true,x:150},6).wait(61));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(281).to({_off:false},6).wait(53).to({startPosition:0},0).to({alpha:0},7).wait(1));
...
(lib.Scene_1_potongan = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(126).to({_off:false},0).to({_off:true,regX:0,x:75,alpha:1},8,cjs.Ease.cubicOut).wait(73));
...
(lib.Scene_1_orang = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(230.75,62.5,0.5,0.5);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({_off:true,x:75,alpha:1},8,cjs.Ease.cubicOut).wait(83));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},8,cjs.Ease.cubicOut).wait(75).to({startPosition:0},0).to({x:-225},7).wait(1));
...
(lib.Scene_1_onestep = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(114.55,214.95,2,2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(274).to({_off:false},0).to({_off:true,scaleX:1,scaleY:1,x:150,y:125},7).wait(67));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(274).to({_off:false},7).wait(59).to({startPosition:0},0).to({scaleX:0.2424,scaleY:0.2424,x:145.9,y:57.65,alpha:0},7).wait(1));
...
(lib.Scene_1_logobig = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(175.3,209.75,2,2);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(350).to({_off:false},0).to({_off:true,scaleX:1,scaleY:1,x:150,y:125,alpha:1},6).wait(56));
...
(lib.Scene_1_kunjungi = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(129.3,205.2,2.0001,2,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(207).to({_off:false},0).to({_off:true,regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:125,alpha:1},8,cjs.Ease.cubicOut).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(207).to({_off:false},8,cjs.Ease.cubicOut).wait(51).to({startPosition:0},0).to({scaleX:0.226,scaleY:0.226,x:170.7,y:62.5,alpha:0},7).wait(1));
...
(lib.Scene_1_hl1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({_off:true,regX:0,x:75,alpha:1},8,cjs.Ease.cubicOut).wait(62));
...
(lib.Scene_1_cursor = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(99.25,62.5,0.5,0.5,0,0,0,0.1,0);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(221).to({_off:false},0).to({_off:true,regX:0,x:75},6).wait(185));
...
(lib.Scene_1_car1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(365.25,62.5,0.5,0.5,0,0,0,0.1,0);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true,regX:0,x:75,alpha:1},9,cjs.Ease.quadOut).wait(97));
...
(lib.Scene_1_button = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(515.05,71.35,0.1391,0.1391);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(216).to({_off:false},0).to({_off:true,scaleX:0.5,scaleY:0.5,x:75,y:62.5},7).wait(189));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(216).to({_off:false},7).wait(29).to({startPosition:0},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:96.9,y:63.4},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(65).to({regX:0,regY:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:96.9,y:63.4},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(57).to({regX:0,regY:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:96.9,y:63.4},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(11));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.logosmall.setTransform(364,45,1,1,0,0,0,364,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.sense).wait(347).to({_off:true},1).wait(85));
	...
	this.timeline.addTween(cjs.Tween.get(this.button).wait(401).to({_off:true},11).wait(21));
