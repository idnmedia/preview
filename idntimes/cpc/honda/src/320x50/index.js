...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,102,640,100],[0,0,640,100],[0,612,640,100],[0,714,640,100],[0,204,640,100],[0,306,640,100],[0,816,640,100],[0,408,640,100],[0,510,640,100],[0,1020,640,100],[0,1530,640,100],[0,1326,640,100],[0,918,640,100],[0,1122,640,100],[0,1224,640,100],[0,1428,640,100],[0,1632,640,100],[0,1836,640,100],[0,1734,640,100]]}
];
...
p.nominalBounds = new cjs.Rectangle(-150,-125,640,100);
...
(lib.Scene_1_onestep = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(228.75,225.95,2,2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(274).to({_off:false},7).wait(59).to({startPosition:0},0).to({scaleX:0.2424,scaleY:0.2424,x:75.5,y:42.55,alpha:0},7).wait(1));
...
(lib.Scene_1_logobig = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(224.9,223.5,2,2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(350).to({_off:false},0).to({_off:true,scaleX:1,scaleY:1,x:150,y:125},6).wait(56));
...
(lib.Scene_1_kunjungi = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(267,224.1,2.0001,2,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(207).to({_off:false},8,cjs.Ease.cubicOut).wait(51).to({startPosition:0},0).to({scaleX:0.226,scaleY:0.226,x:52.25,y:46.3,alpha:0},7).wait(1));
...
(lib.Scene_1_cursor = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(275.7,62.5,0.5,0.5,0,0,0,0.1,0);
	this.instance._off = true;
...
(lib.Scene_1_button = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(240.15,50.15,0.1391,0.1391);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(216).to({_off:false},7).wait(29).to({startPosition:0},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:83.3,y:62.1},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(65).to({regX:0,regY:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:83.3,y:62.1},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(57).to({regX:0,regY:0,scaleY:0.5,x:75,y:62.5},0).to({regX:0.2,scaleX:0.4833,scaleY:0.4832,x:83.3,y:62.1},4).wait(1).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:0.5,scaleY:0.4998,x:75.05,y:62.6},4).wait(11));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.logosmall.setTransform(160,25,1,1,0,0,0,160,25);
	...
	this.bg1.setTransform(160,25,1,1,0,0,0,160,25);
	this.bg1.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(-140,-1.5,750.2,77.5);
// library properties:
lib.properties = {
