...
// stage content:
(lib.LALightsMoodtivationInvestasi_320x480 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FLIPYOURMOOD_320x480min.png?1689580497564", id:"FLIPYOURMOOD_320x480min"},
		{src:"images/hand_320x480min.png?1689580497564", id:"hand_320x480min"},
		{src:"images/LogoLA_320x480min.png?1689580497564", id:"LogoLA_320x480min"},
		{src:"images/orang_320x480min.png?1689580497564", id:"orang_320x480min"},
		{src:"images/PHW_320x480min.png?1689580497564", id:"PHW_320x480min"},
		{src:"images/ribbon_320x480min.png?1689580497564", id:"ribbon_320x480min"},
		{src:"images/skymin.jpg?1689580497564", id:"skymin"}
	],
	preloads: []
};
