! function(t, i, e) {
	...
	s.prototype.extend = function() {
		...
		for (var t = 0, i = this.layers.length; i > t; t++) {
			var e = this.layers[t];
			this.transform3DSupport && this.accelerate(e), e.style.position = "absolute",  e.style.height = "100%", e.style.width = "100%", e.style.display = "block", this.depths.push(this.data(e, "depth") || 0)
		}
